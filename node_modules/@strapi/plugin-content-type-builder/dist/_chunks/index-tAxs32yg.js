...
const index$1 = require("./index-mCrdFqUQ.js");
...
const ListView$1 = React.lazy(() => Promise.resolve().then(() => require("./ListView-iDatcBgM.js")));
const RecursivePath = () => {
...
const ListView = React.lazy(() => Promise.resolve().then(() => require("./ListView-iDatcBgM.js")));
const App = () => {
  const { formatMessage } = reactIntl.useIntl();
...
//# sourceMappingURL=index-tAxs32yg.js.map
