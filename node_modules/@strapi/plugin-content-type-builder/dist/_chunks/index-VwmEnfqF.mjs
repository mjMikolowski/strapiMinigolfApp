...
const ListView$1 = lazy(() => import("./ListView-E2t0fdNw.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-E2t0fdNw.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-VwmEnfqF.mjs.map
