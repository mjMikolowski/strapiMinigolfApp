...
const useWebhooks = require("./useWebhooks-4srjS3Tn.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-7FLeEv3l.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-V9-fJZ0T.js.map
