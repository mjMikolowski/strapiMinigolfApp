...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-fi6xYVen.mjs";
...
import { u as useWebhooks } from "./useWebhooks-aWrXuFDX.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-_6nhYFKy.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-aq3TODI6.mjs.map
