...
export interface ApiCourseCourse extends Schema.CollectionType {
  ...
  attributes: {
    ...
    type: Attribute.Enumeration<
      ['CONCRETE', 'ETERNIT', 'FELTGOLF', 'MOS', 'OTHER']
    > &
      Attribute.Required &
...
export interface ApiLaneLane extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::lane.lane', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::lane.lane', 'oneToOne', 'admin::user'> &
      Attribute.Private;
...
export interface ApiRoundRound extends Schema.CollectionType {
  ...
  attributes: {
    roundNumber: Attribute.Integer & Attribute.Required;
    tournament: Attribute.Relation<
      'api::round.round',
      'oneToOne',
      'api::tournament.tournament'
...
export interface ApiTournamentTournament extends Schema.CollectionType {
  ...
  attributes: {
    ...
    status: Attribute.Enumeration<
      ['PREPARED', 'OPEN_RESIGRATION', 'STARTED', 'FINISHED']
    > &
      Attribute.Required &
      Attribute.DefaultTo<'PREPARED'>;
    isPublic: Attribute.Boolean;
    isTeam: Attribute.Boolean;
    course: Attribute.Relation<
      'api::tournament.tournament',
      'oneToOne',
      'api::course.course'
